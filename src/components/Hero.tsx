    ...
    <section className="relative isolate overflow-hidden bg-neutral-950 text-white" aria-labelledby="hero-title">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 pb-20 pt-36 sm:px-6 md:pb-28 md:pt-44 lg:grid-cols-[1.1fr_.9fr] lg:px-8">
        <div className="max-w-2xl">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-xs font-semibold text-neutral-200 backdrop-blur"><Sparkles className="h-3.5 w-3.5" aria-hidden="true" /> Gudang Planet · Produksi Apparel</div>
          <h1 id="hero-title" className="text-4xl font-black leading-[1.04] tracking-tight text-white sm:text-5xl lg:text-7xl">Saatnya Punya <span className="text-neutral-400">Brand Sendiri.</span></h1>
          <p className="mt-6 max-w-xl text-base leading-7 text-neutral-300 sm:text-lg">Partner produksi terpercaya untuk clothing brand dan toko grosir. Wujudkan kaos berkualitas dengan harga yang ramah untuk modal usaha.</p>
