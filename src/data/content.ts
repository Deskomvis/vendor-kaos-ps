...
export const SERVICES: ServiceDetail[] = [
  ...
  },
  {
    ...
    tag: 'Spesialis Partai & Komunitas',
    badge: 'Ekonomis & Tahan Bertahun-tahun',
    minOrder: 'Mulai 12 - 24 Pcs',
    priceRange: 'Rp 42.000 - Rp 65.000 / pcs',
    productionTime: '4 - 7 Hari Kerja',
    features: [
      'Kualitas sablon standar distro internasional & clothing brand besar',
      'Pilihan tinta: Plastisol HD, Rubber Quik, Discharge (cabut warna)',
      'Biaya per kaos sangat murah saat kuantiti meningkat (>50 pcs)',
